...
namespace rml::dumper::target
{
	static constexpr std::array<AnchorSpec, anchor_count> windows_x64_anchors{{
	    ...
	    {Anchor::luaM_visitgco, "40 56 41 54 41 57 48 83 EC 30 48 8B 41"},
	    {Anchor::luaC_enumheap, "40 53 48 83 EC 40 48 89 54 24 ? 48 8B D9"},
	    {Anchor::luaH_new, "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 41 8B F0 8B EA 44 0F B6 41"},
	    {Anchor::luaH_setnum, "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 30 41 8D 40"},
	    {Anchor::setnodevector,
	     "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 41 56 41 57 48 83 EC 20 41 8B E8"},
	    {Anchor::lua_setmetatable, "40 53 48 83 EC 20 48 8B D9 85 D2 7E ? 4C 8B 49"},
	    {Anchor::lua_getreadonly,
