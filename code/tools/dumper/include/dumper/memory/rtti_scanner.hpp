...
namespace memory::rtti
{
	...
	{
	public:
		rtti_info(void** vft, complete_object_locator* col, type_descriptor* td, class_hierarchy_descriptor* chd, base_class_descriptor* bcd) noexcept :
	...
	public:
         ...
         */
		[[nodiscard]] static const std::unordered_map<std::string, std::unique_ptr<rtti_info> >& get_all_classes() noexcept
		{
	...
	private:
         ...
         */
		[[nodiscard]] bool validate_and_process_rtti(complete_object_locator** pointer_col, complete_object_locator* col, std::uint8_t* base_address) const;
