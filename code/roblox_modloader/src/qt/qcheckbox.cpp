...
namespace rml::qt
{
	...
	{
		static const auto construct = detail::widgets<void* (*)(void*, const void*, void*)>("QCheckBox::QCheckBox(QString const&, QWidget*)");
		if (!construct)
			return nullptr;
	...
	{
		static const auto dtor = detail::widgets<void (*)(void*)>("QCheckBox::~QCheckBox()");
