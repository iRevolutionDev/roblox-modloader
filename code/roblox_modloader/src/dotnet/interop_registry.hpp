...
namespace rml::dotnet
{
	...
	struct alignas(8) InteropTable
	{
		...
		void(__cdecl* reflection_invoke)(uintptr_t instance, const char* function_name,
		                                  const InteropVariant* args, uint32_t arg_count,
		                                  InteropVariant* out_result);

		void(__cdecl* reflection_get_property)(uintptr_t instance, const char* property_name,
		                                        InteropVariant* out_value);

		void(__cdecl* reflection_set_property)(uintptr_t instance, const char* property_name,
