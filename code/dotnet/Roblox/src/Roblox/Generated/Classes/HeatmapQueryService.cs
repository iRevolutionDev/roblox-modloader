...
namespace Roblox
{
    [RobloxClass("HeatmapQueryService")]
    public partial class HeatmapQueryService : Instance
    {
        /// <summary>Wraps an existing native Roblox instance identified by <paramref name="handle"/>.</summary>
        /// <param name="handle">Native pointer to the underlying Roblox HeatmapQueryService.</param>
