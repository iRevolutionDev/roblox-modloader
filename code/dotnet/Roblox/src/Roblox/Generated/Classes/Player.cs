...
namespace Roblox
{
    ...
    public class Player : Instance
    {
        ...
        /// <summary>
        /// Deprecated: This method has been superseded by GetFriendsOnlineAsync().Returns a dictionary of online connections. Returns the product information of an asset using its asset ID.
        /// </summary>
        ...
        /// <summary>
        /// Deprecated: This function is obsolete because the "best friends" feature was removed. Use Player:IsFriendsWithAsync() instead.Returns whether a player is connections with the specified user.
        /// </summary>
        /// <param name="userId">A <c>long</c> value.</param>
        /// <returns>A <c>bool</c> value returned by the engine.</returns>
        ...
        /// <summary>
        /// Deprecated: This method has been superseded by the Player:IsFriendsWithAsync() method which should be used for new work.Checks whether a player is a connection of the user with the given Player.UserId.
        /// </summary>
        /// <param name="userId">A <c>long</c> value.</param>
        /// <returns>A <c>bool</c> value returned by the engine.</returns>
        ...
        public bool IsFriendsWithAsync(long userId)
