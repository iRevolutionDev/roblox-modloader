...
namespace Roblox
{
    ...
    public class MarketplaceService : Instance
    {
        ...
        /// <summary>
        /// <c>MarketplaceService.PromptRobloxSubscriptionPurchase</c>
        /// </summary>
        /// <param name="user">A <c>Player?</c> value.</param>
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        ...
        public Instance? GetDeveloperProductsAsync()
            => global::Roblox.Reflection.Invoke<Instance?>(this, "GetDeveloperProductsAsync");
        ...
        /// <summary>
        /// <c>MarketplaceService.GetRobloxSubscriptionDetailsAsync</c>
        /// </summary>
        /// <param name="user">A <c>Player?</c> value.</param>
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        ...
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        public object? PerformPurchase(Enum.InfoType infoType, long productId, int expectedPrice, string? requestId, bool isRobloxPurchase, string? collectibleItemId, string? collectibleProductId, string? idempotencyKey, string? purchaseAuthToken, long timedOptionsDays)
            => global::Roblox.Reflection.Invoke<object?>(this, "PerformPurchase", infoType, productId, expectedPrice, requestId, isRobloxPurchase, collectibleItemId, collectibleProductId, idempotencyKey, purchaseAuthToken, timedOptionsDays);
        ...
        /// <summary>
        /// <c>MarketplaceService.PromptRobloxSubscriptionPurchaseFinished</c>
        /// <para><b>Note:</b> Event binding is not yet implemented in the native layer.</para>
        /// </summary>
