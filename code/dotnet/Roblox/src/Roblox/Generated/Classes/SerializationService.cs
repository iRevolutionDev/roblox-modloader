...
namespace Roblox
{
    ...
    public class SerializationService : Instance
    {
        ...
        public object? DeserializeInstancesAsync(object? buffer)
            => global::Roblox.Reflection.Invoke<object?>(this, "DeserializeInstancesAsync", buffer);

        /// <summary>
        /// Serializes a list of instances to the .rbxm format, returning a buffer or .rbxm content.
        /// </summary>
        /// <param name="inputInstances">A <c>object?</c> value.</param>
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        /// <seealso href="https://create.roblox.com/docs/reference/engine/classes/SerializationService#SerializeInstancesAsync"/>
        public object? SerializeInstancesAsync(object? inputInstances)
