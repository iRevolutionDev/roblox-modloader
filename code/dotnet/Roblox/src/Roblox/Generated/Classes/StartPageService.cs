...
namespace Roblox
{
    ...
    public class StartPageService : Instance
    {
        ...
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        public object? OpenPlace(long placeId, long universeId, bool launchTutorial)
            => global::Roblox.Reflection.Invoke<object?>(this, "openPlace", placeId, universeId, launchTutorial);
