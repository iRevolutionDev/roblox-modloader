...
namespace Roblox
{
    ...
    public class BadgeService : Instance
    {
        ...
        public bool AwardBadgeAsync(long userId, long badgeId)
        ...
        /// <summary>
        /// Deprecated: This method has been superseded by BadgeService:UserHasBadgeAsync() which should be used for new instead.Checks whether a user has the badge given the Player.UserId and the badge ID.
        /// </summary>
        /// <param name="userId">A <c>long</c> value.</param>
        /// <param name="badgeId">A <c>long</c> value.</param>
        /// <returns>A <c>bool</c> value returned by the engine.</returns>
