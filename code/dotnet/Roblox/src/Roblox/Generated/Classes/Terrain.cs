...
namespace Roblox
{
    ...
    public class Terrain : BasePart
    {
        ...
        /// </summary>
        public static Terrain? FromHandle(nuint handle)
        ...
        /// <summary>
        /// Deprecated: Sets the specified terrain voxel's material to ''Water'' and sets its occupancy to 1.Returns true if the current game is using the smooth terrain system.
        ...
        /// <summary>
        /// MaterialColors represents the editor for the Material Color feature, and cannot be edited by scripts. To get the color of a material, use: Terrain:GetMaterialColor() To set the color of a material, use: Terrain:SetMaterialColor()
        /// </summary>
        ...
        /// <summary>
        /// Deprecated: This item is a deprecated function of a legacy Terrain engine that has been removed. Do not use it for new work.(OBSOLETE) No longer does anything.
        /// </summary>
        ...
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        /// <seealso href="https://create.roblox.com/docs/reference/engine/classes/Terrain#ClearVoxelsAsync_beta"/>
        ...
        /// <summary>
        /// Deprecated: Since all places now automatically use the new terrain engine, this method is obsolete. Do not use it for new work.Transforms the legacy terrain engine into the new terrain engine.
        /// </summary>
        /// <returns>A <c>object?</c> value returned by the engine.</returns>
        ...
        /// <summary>
        /// Deprecated: This item is a deprecated function of a legacy Terrain engine that has been removed. Do not use it for new work.Returns the closest CellMaterial from the legacy terrain engine that matches the smooth terrain voxel specified.
        /// </summary>
        /// <param name="x">A <c>int</c> value.</param>
        /// <param name="y">A <c>int</c> value.</param>
        /// <param name="z">A <c>int</c> value.</param>
        ...
        /// <summary>
        /// Deprecated: This item is a deprecated function of a legacy Terrain engine that has been removed. Do not use it for new work.Returns if the cell is a water cell.
        /// </summary>
        /// <param name="x">A <c>int</c> value.</param>
        /// <param name="y">A <c>int</c> value.</param>
        /// <param name="z">A <c>int</c> value.</param>
        ...
        /// <seealso href="https://create.roblox.com/docs/reference/engine/classes/Terrain#IterateVoxelsAsync_beta"/>
        ...
        /// <seealso href="https://create.roblox.com/docs/reference/engine/classes/Terrain#ModifyVoxelsAsync_beta"/>
        ...
        /// <seealso href="https://create.roblox.com/docs/reference/engine/classes/Terrain#ReadVoxelsAsync_beta"/>
        ...
        /// <seealso href="https://create.roblox.com/docs/reference/engine/classes/Terrain#WriteVoxelsAsync_beta"/>
